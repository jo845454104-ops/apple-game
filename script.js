import { submitScore, fetchTopScores, getNextReset, fetchScoresForAdmin, fetchMyScores } from "./leaderboard.js?v=65";
import { findTargeted } from "./profanity.js?v=65";
import {
  ROULETTE_MIN_SCORE,
  DAILY_SPINS,
  segments,
